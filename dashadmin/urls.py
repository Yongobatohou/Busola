...
urlpatterns = [
    ...
    #Team views
    path('team/team-list/', views.team_list, name='team_list'),
    path('team/team-add/', views.team_add, name='team_add'),
    path('team/team-edit/<int:id>/', views.team_edit, name='team_edit'),
    path('team/team-update/<int:id>/', views.team_update, name='team_update'),
    path('team/team-delete/<int:id>/', views.team_delete, name='team_delete'),

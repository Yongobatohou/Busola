...
handler404 = 'ONGBUSOLA.views.custom_404'
handler500 = 'ONGBUSOLA.views.custom_500'
...
urlpatterns = [
    ...
    path('mention-legales/', views.mention_legales, name='mention_legales'),
    path('politique-confientialite/', views.politique_condentialite, name='politique_condentialite')
